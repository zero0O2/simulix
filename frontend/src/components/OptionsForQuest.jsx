...
const OptionsForQuest = ({ text, children, path, info }) => {
    ...
    return (
        <>
            <button 
                className="bg-[var(--cor02)] flex justify-center items-center gap-[10px] hover:bg-[var(--cor01)] relative duration-300 cursor-pointer p-[10px_20px] rounded"
            ...
            >   
                ...
                {info && <>
                    ...
                    <div className="pointer-events-none peer-hover:opacity-100 opacity-0 max-w-[350px] z-10 duration-300 ease-in-out absolute right-0 top-[100%] bg-[var(--03)] text-[var(--textBlack)] text-[13px] p-[10px] rounded-[8px]">
                        {info}
                    </div>
                </>} 
            </button>
