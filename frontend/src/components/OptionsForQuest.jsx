        ...
        <>
            ...
            >   
                ...
                {info && <>
                    ...
                    <div className="pointer-events-none peer-hover:opacity-100 opacity-0 max-w-[350px] z-10 duration-300 ease-in-out absolute right-0 top-[100%] bg-[var(--textWhite)] text-[var(--textBlack)] text-[13px] p-[10px] rounded-[8px]">
                        {info}
                    </div>
                </>} 
            </button>
