        ...
        <>
            ...
            <div className=" flex-1 w-full">
                <aside className="w-full relative  h-[40px] justify-between items-center gap-[20px] flex">
                    ...
                    <button onClick={()=> setQuestoesFoco(prev=>!prev)} className="border-1 border-[var(--azulCeu)] w-[40px] h-[40px] flex justify-center items-center absolute right-0 cursor-pointer text-[30px] text-[var(--azulCeu)]">{questoesFoco ? <MdFullscreenExit/> : <MdFullscreen/>}</button>
                </aside>
